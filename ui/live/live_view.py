...
from ui.live.live_ai_controller import AIController
from ui.live.components.transcript_panel import TranscriptPanel
from ui.live.components.prompter_panel import PrompterPanel
...
class LiveInterviewView:
    ...
    def __init__(self, app_instance):
        ...
        if StreamingTranscriber:
            try:
                self.transcriber = StreamingTranscriber(model_size="small")
    ...
    def create_ui(self):
        ...
        with ui.column().classes(
            'w-full h-[calc(100vh-64px)] '  # 64px = header height
            'p-2 sm:p-4 '
            'gap-2 sm:gap-4 '
            'max-w-6xl mx-auto'
        ):
